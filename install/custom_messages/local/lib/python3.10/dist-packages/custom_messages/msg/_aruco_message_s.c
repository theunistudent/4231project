...
bool custom_messages__msg__aruco_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._aruco_message.ArucoMessage", full_classname_dest, 47) == 0);
  }
  custom_messages__msg__ArucoMessage * ros_message = _ros_message;
  {  // id
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint16_t * dest = ros_message->id.data;
...
{
  /* NOTE(esteve): Call constructor of ArucoMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._aruco_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoMessage");
  ...
  {  // id
    ...
    if (ros_message->id.size > 0) {
      ...
      uint16_t * src = &(ros_message->id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->id.size * sizeof(uint16_t));
      assert(data != NULL);
