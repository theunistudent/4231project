...
{
  new (message_memory) messages::msg::ArucoMessage(_init);
}

void ArucoMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<messages::msg::ArucoMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArucoMessage_message_member_array[3] = {
  {
    ...
    offsetof(messages::msg::ArucoMessage, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages::msg::ArucoMessage, x),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(messages::msg::ArucoMessage, y),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArucoMessage_message_members = {
  ...
  3,  // number of fields
  sizeof(messages::msg::ArucoMessage),
...
{
  return &::messages::msg::rosidl_typesupport_introspection_cpp::ArucoMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages, msg, ArucoMessage)() {
  return &::messages::msg::rosidl_typesupport_introspection_cpp::ArucoMessage_message_type_support_handle;
}
