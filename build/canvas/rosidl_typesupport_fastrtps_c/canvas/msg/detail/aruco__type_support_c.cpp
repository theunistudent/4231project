...
#include "canvas/msg/detail/aruco__rosidl_typesupport_fastrtps_c.h"
...
#include "canvas/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Aruco__ros_msg_type = canvas__msg__Aruco;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Aruco__ros_msg_type * ros_message = static_cast<const _Aruco__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Aruco__ros_msg_type * ros_message = static_cast<_Aruco__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_canvas
size_t get_serialized_size_canvas__msg__Aruco(
  const void * untyped_ros_message,
...
static uint32_t _Aruco__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_canvas__msg__Aruco(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_canvas
size_t max_serialized_size_canvas__msg__Aruco(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Aruco__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_canvas__msg__Aruco(
...
static message_type_support_callbacks_t __callbacks_Aruco = {
  "canvas::msg",
  "Aruco",
...
static rosidl_message_type_support_t _Aruco__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, canvas, msg, Aruco)() {
  return &_Aruco__type_support;
}
