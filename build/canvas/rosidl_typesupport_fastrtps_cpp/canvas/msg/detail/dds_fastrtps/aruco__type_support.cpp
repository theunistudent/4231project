...
#include "canvas/msg/detail/aruco__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const canvas::msg::Aruco *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_canvas
const rosidl_message_type_support_t *
get_message_type_support_handle<canvas::msg::Aruco>()
{
  return &canvas::msg::typesupport_fastrtps_cpp::_Aruco__handle;
}
