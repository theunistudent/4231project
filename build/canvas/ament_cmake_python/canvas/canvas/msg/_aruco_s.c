...
bool canvas__msg__aruco__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("canvas.msg._aruco.Aruco", full_classname_dest, 23) == 0);
  }
  canvas__msg__Aruco * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Aruco */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("canvas.msg._aruco");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Aruco");
