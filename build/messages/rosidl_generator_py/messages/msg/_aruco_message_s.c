...
bool messages__msg__aruco_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("messages.msg._aruco_message.ArucoMessage", full_classname_dest, 40) == 0);
  }
  messages__msg__ArucoMessage * ros_message = _ros_message;
  {  // id
...
PyObject * messages__msg__aruco_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("messages.msg._aruco_message");
