...
#include "messages/msg/detail/aruco_message__rosidl_typesupport_fastrtps_c.h"
...
using _ArucoMessage__ros_msg_type = messages__msg__ArucoMessage;
...
size_t get_serialized_size_messages__msg__ArucoMessage(
  const void * untyped_ros_message,
...
static uint32_t _ArucoMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_messages__msg__ArucoMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_messages
size_t max_serialized_size_messages__msg__ArucoMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ArucoMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_messages__msg__ArucoMessage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, messages, msg, ArucoMessage)() {
