...
#include "custom_messages/msg/detail/aruco_message__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // id, x, y
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // id, x, y

// forward declare type support functions


using _ArucoMessage__ros_msg_type = custom_messages__msg__ArucoMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ArucoMessage__ros_msg_type * ros_message = static_cast<const _ArucoMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ArucoMessage__ros_msg_type * ros_message = static_cast<_ArucoMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_custom_messages__msg__ArucoMessage(
  const void * untyped_ros_message,
...
static uint32_t _ArucoMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__ArucoMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__msg__ArucoMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ArucoMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__ArucoMessage(
...
static message_type_support_callbacks_t __callbacks_ArucoMessage = {
  "custom_messages::msg",
  "ArucoMessage",
...
static rosidl_message_type_support_t _ArucoMessage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ArucoMessage,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, ArucoMessage)() {
  return &_ArucoMessage__type_support;
}
