...
#include "custom_messages/msg/detail/aruco_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const custom_messages::msg::ArucoMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_messages::msg::ArucoMessage *>(
    untyped_ros_message);
...
{
  return &custom_messages::msg::typesupport_fastrtps_cpp::_ArucoMessage__handle;
}
